...
excel = pd.read_excel(r'C:\Users\chana\Downloads\croprecommendationML-main\croprecommendationML-main\crop.xlsx', header=0)    # Importing our excel data from a specific file.
...
layout = [
		 [sg.Text('                      CROP RECOMMENDATION ASSISTANT', font=("Times New Roman", 30), text_color = 'RED')],                                                    # Defining the layout of the Graphical User Interface. It consist of some text, Buttons, and blanks to take Input.                                                        
         ...
         [sg.Button('Submit', font=("Helvetica", 20), button_color=('white', 'green'), size=(10, 1)),sg.Button('Quit', font=("Helvetica", 20), button_color=('white', 'red'), size=(10, 1))]]
